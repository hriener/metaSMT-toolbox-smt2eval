...
using Solver = metaSMT::DirectSolver_Context< metaSMT::BitBlast< metaSMT::SAT_Clause < metaSMT::solver::Lingeling > > >;

int main( int argc, char *argv[] )
{
  return metaSMT_satisfiability_checker_main< Solver >( argc, argv );
}
